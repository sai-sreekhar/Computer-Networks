...
set tcpReno12 [new Agent/TCP]
set tcpReno23 [new Agent/TCP]

# Set TCP Reno parameters
$tcpReno12 set window_ 20
$tcpReno23 set window_ 20

# Attach TCP agents to the corresponding nodes
$ns attach-agent $node1 $tcpReno12
$ns attach-agent $node2 $tcpReno23
...
$ns connect $tcpReno12 $sink2
$ns connect $tcpReno23 $sink3

# Attach TCP agents to the FTP applications
set ftpReno12 [new Application/FTP]
set ftpReno23 [new Application/FTP]
$ftpReno12 attach-agent $tcpReno12
$ftpReno23 attach-agent $tcpReno23

# Data packet generation starting time
$ns at 1.0 "$ftpReno12 start"
$ns at 3.0 "$ftpReno23 start"

# Data packet generation ending time
$ns at 6.0 "$ftpReno12 stop"
$ns at 8.0 "$ftpReno23 stop"
