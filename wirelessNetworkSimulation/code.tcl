...
# Defining Communication between nodes

# Defining transport agents for sending
set tcp12 [new Agent/TCP]
set tcp23 [new Agent/TCP]

# Attaching transport agents to sender nodes
$ns attach-agent $node1 $tcp12
$ns attach-agent $node2 $tcp23

# Defining transport agents for receiving
set sink2 [new Agent/TCPSink]
set sink3 [new Agent/TCPSink]

# Attaching transport agents to receiver nodes
$ns attach-agent $node2 $sink2
$ns attach-agent $node3 $sink3

# Connecting sending and receiving transport agents
$ns connect $tcp12 $sink2
$ns connect $tcp23 $sink3

# Defining Application instances
set ftp12 [new Application/FTP]
set ftp23 [new Application/FTP]

# Attaching transport agents to application agents
$ftp12 attach-agent $tcp12
$ftp23 attach-agent $tcp23

# Data packet generation starting time
$ns at 1.0 "$ftp12 start"
$ns at 3.0 "$ftp23 start"

# Data packet generation ending time
$ns at 6.0 "$ftp12 stop"
$ns at 8.0 "$ftp23 stop"
